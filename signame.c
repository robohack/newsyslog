...
static char sccsid[] = "@(#)newsyslog:$Name:  $:$Id: signame.c,v 1.7 2003/07/08 16:56:55 woods Exp $";*/
...
#  include "ERROR: your system has no native sys_signame and is not yet supported with a custom one"
# endif
